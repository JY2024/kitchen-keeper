            ...
            history: [
                {
                    role: "user",
                    parts: [{
                        text: `You are a meal planning assistant. Your task is to generate JSON data containing details about different meals. The JSON should have the following structure:
